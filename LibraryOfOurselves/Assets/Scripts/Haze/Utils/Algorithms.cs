...
///A collection of well-known algorithms
...
namespace Haze{
	public static class Algorithms{
		...
		/// Implementation of the Fisher-Yates shuffle algorithm (https://stackoverflow.com/questions/273313/randomize-a-listt)
		...
		/// Implementation from https://github.com/j-bbr/PolygonColliderSimplification
		...
		private static void DouglasPeuckerReductionRecursive(List<Vector2> points, Int32 firstPoint, Int32 lastPoint, Double tolerance, ref List<Int32> pointIndexsToKeep){
